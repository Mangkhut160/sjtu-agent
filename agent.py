...
TOOLS = [
    {
        ...
        "function": {
            "name": "get_ddls",
            "description": "获取所有平台（Canvas / aihaoke / 中国大学MOOC）未完成 DDL，按截止时间升序。",
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                "type": "object",
                "properties": {
                    "jaccount_username": {"type": "string", "description": "交大 jAccount 用户名（用于 aihaoke 和物理实验）"},
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "下载近期作业材料（Canvas 题目说明/附件 + aihaoke 作业页面截图/附件），"
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "skip_aihaoke": {"type": "boolean", "description": "跳过 aihaoke，默认 false"},
                    "course_filter": {
                        "type": "string",
...
1. 交大 jAccount 用户名和密码（用于 aihaoke 和物理实验自动登录）
